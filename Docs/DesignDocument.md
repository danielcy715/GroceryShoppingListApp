...
Version 2.0. Changed the Mockup

Version 2.0 : Class Diagram Changed. Team felt during implementation that it is easier to use one item Class to manipulate rather than having two classes.
